    ...
    <div>
      <div className='tut-main-container'>
        <Sidebar />
          ...
          <iframe className='youtube-iframe' width="640" height="480" src="https://www.youtube.com/embed/V3w7HABhSOg" title="YouTube video player" frameborder="0" 
            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe><br/>
          <p>Figure 1: Video - Horizon Game Engine – Add object to scene</p>
          ...
          <p>Figure 2: Horizon game engine – Scene setup </p>
          ...
          <p>Figure 3: Horizon game engine – Creating new object </p>
          ...
          <p>Figure 4: Horizon game engine – New object created </p>
          ...
          <p>Figure 5: Horizon game engine – Selecting & rendering new object </p>
          ...
          <p>Figure 6: Horizon game engine – Change name and colour </p>
          ...
          <p>Figure 7: Horizon game engine – Q selected </p>
          <img src={w_func} className='pic-max-width'></img>
          <p>Figure 8: Horizon game engine – W selected </p>
          <img src={e_func} className='pic-max-width'></img>          
          <p>Figure 9: Horizon game engine – E selected </p>
          <img src={r_func} className='pic-max-width'></img>
          <p>Figure 10: Horizon game engine – R selected </p>
          ...
          <p>Figure 11: Horizon game engine – Delete object </p>
