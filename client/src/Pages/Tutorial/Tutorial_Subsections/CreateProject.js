    ...
    <div className='tutorial-container'>
      ...
      <div className='tutorial-content-container'>
          <div className='tut-content'>
            ...
            <p>for viframe className='youtube-iframe' src="https://www.youtube.com/embed/-NYTRSsual" reference!</p>
            ...
            <img src={File_menu} alt="HorizonGE File menu" className='center_img_no_width'></img>
            ...
            <img src={File_menu_open} alt="HorizonGE File menu open" className='center_img_no_width'></img>
            ...
            <img src={new_project_dialog} alt="HorizonGE File menu" className='center_img_no_width'></img>
