  ...
  return (
    <div className='gmTutMainContainer'>
        <GameSidebar />
          ...
          <strong id='step3'>Step 3: Scene dialog box</strong>
          ...
          <strong id='step4'>Step 4: New Scene setup</strong>
          ...
          <strong id='step5'>Step 5: Create a second scene</strong>
          ...
          <strong id='step6'>Step 6: Second Scene toggle files setup</strong>
