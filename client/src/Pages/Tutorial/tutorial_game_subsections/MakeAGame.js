    ...
    <div className='gmTutMainContainer'>
          ...
          <div className='gmTutContent'>
            ...
            <p>The first step when starting to work with Horizon Engine is to create a new 
              ...
              <p>In order to add sprites to our project, we need to add a sprite sheet into the sprites folder of the project and after that add a file with the same name as the sprite sheet and with a .meta extension (e.g. image.png and image.meta). The .meta file will contain two lines: </p>
              <p>•	width:X</p>
              <p>•	height:Y</p>
