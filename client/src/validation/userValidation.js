...
export const userSignUpSchema = yup.object().shape({
    userName: yup.string().min(4, "User name must be longer than 4 characters").max(20, "User name must not be longer than 20 characters").required("Please enter a user name"),
